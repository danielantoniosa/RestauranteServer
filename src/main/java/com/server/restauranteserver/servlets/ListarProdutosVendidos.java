 ...
 * @author Daniel
 */
@WebServlet(name = "ListarProdutosVendidos", urlPatterns = {"/restaurante_server/ListarProdutosVendidos"}, initParams = {
...
public class ListarProdutosVendidos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cod > 0) {
            ...
            ArrayList<ProdutosGravados> u = con.listarProdutosVendidosCaixa(cod);
