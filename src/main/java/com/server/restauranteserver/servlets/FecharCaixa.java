 ...
 * @author Daniel
 */
@WebServlet(name = "FecharCaixa", urlPatterns = {"/restaurante_server/FecharCaixa"}, initParams = {
    @WebInitParam(name = "caixa", value = ""),
    @WebInitParam(name = "nomeUsuario", value = ""),
    @WebInitParam(name = "senha", value = "")})
public class FecharCaixa extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cod > 0) {
            ...
            response.setHeader("sucesso", con_caixa.fecharCaixa(request.getParameter("caixa")));
