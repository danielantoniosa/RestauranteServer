...
public class EmpresaBEAN {
    ...
    public String getExpriraLicenca() {
        return expriraLicenca;
    }

    public void setExpriraLicenca(String expriraLicenca) {
        this.expriraLicenca = expriraLicenca;
    }
